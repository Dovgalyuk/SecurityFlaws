...
; 12   :   printf("%f %f %f %s\n", param1, param2, param3, buf);
	...
	movsd	xmm3, QWORD PTR param3$[rsp]
	movd	r9, xmm3
	movsd	xmm2, QWORD PTR param2$[rsp]
	movd	r8, xmm2
	movsd	xmm1, QWORD PTR param1$[rsp]
	movd	rdx, xmm1
	lea	rcx, OFFSET FLAT:$SG5153
	call	printf
